...
export const navItems: NavItem[] = [
    ...
    {
        displayName: 'Funções Harmônicas',
        iconName: 'solar:music-note-outline',
        route: '/estudos/funcoesharmonicas',
    },
    {
        displayName: 'Cadências Harmônicas',
        iconName: 'solar:music-note-outline',
        route: '/estudos/cadenciasharmonicas',
    },
    {
        displayName: 'Progressões Harmônicas',
        iconName: 'solar:music-note-outline',
        route: '/estudos/progressoesharmonicas',
    },
    {
        navCap: 'Exercícios',
    },
